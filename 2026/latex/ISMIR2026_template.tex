...
We adopt a ``\textbf{(6+n)-page policy}'' for ISMIR \conferenceyear. That is, each paper may have a maximum of six pages of technical content (including figures and tables), with additional optional pages that contain only references and optional acknowledgments, AI Usage Statement and Ethics Statement. \textbf{Note that acknowledgments should not be included in the anonymized submission.}
...
In line with the ISMIR 2026 AI Usage Policy, if you need to declare and explain the use of AI tools in the work described in the paper, you can do so by including a section titled ``AI Usage Statement" at the end of the paper. The AI Usage Statement section can be included both at submission time and in your camera-ready version. See the Call for Papers and Author Guidelines for more details. The AI Usage Statement section does \textit{not} count towards the page limit for scientific content. 

\section{Ethics Statement}

You may include an optional Ethics Statement section at the end of the paper to provide additional ethical considerations related to your paper. The Ethics Statement section can be included both at submission time and in your camera-ready version. See the Call for Papers and Submission Guidelines for details. The Ethics Statement section does \textit{not} count towards the page limit for scientific content.
...
\textbf{Please make sure that the author names, paper title and proceedings title are shown correctly in the copyright notice.} For \LaTeX\ users, the proceedings title will be automatically loaded when you remove the global option `submission' when importing the `ismir' package (i.e., \texttt{\textbackslash usepackage\{ismir\}} in line 16). For Word users, you will need to manually replace ``submitted to \textit{ISMIR}, 2026'' to ``in \textit{Proc. of the 27th Int. Society for Music Information Retrieval Conf.}, Abu Dhabi, UAE, 2026.''
